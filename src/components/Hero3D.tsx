    ...
    >
      ...
      >
        ...
        <g style={{ transformOrigin: '300px 300px', animation: 'hero3d-spin-rev 12s linear infinite' }}>
          <ellipse cx="300" cy="300" rx="175" ry="55" fill="none" stroke="#0891b2" strokeWidth="0.8" opacity="0.22" />
          <ellipse cx="300" cy="300" rx="175" ry="55" fill="none" stroke="#0891b2" strokeWidth="0.5" opacity="0.12"
