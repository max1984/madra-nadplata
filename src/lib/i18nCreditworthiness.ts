...
const plCw: Record<CreditworthinessTranslationKey, string> = {
  ...
  cw_scenario_rename_hint: 'Kliknij, aby zmienić nazwę',
  ...
  error_cw_years: 'Okres kredytowania musi być między 1 a 35 lat',
...
const enCw: Record<CreditworthinessTranslationKey, string> = {
  ...
  cw_scenario_rename_hint: 'Click to rename',
  ...
  error_cw_years: 'Loan term must be between 1 and 35 years',
