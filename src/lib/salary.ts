...
/** Runtime lista tych samych 10 stawek, do zbudowania dropdownu w UI bez powielania listy. */
export const RYCZALT_RATES: RyczaltRate[] = [0.02, 0.03, 0.055, 0.085, 0.10, 0.12, 0.125, 0.14, 0.15, 0.17];
